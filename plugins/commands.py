...
@phoethar2.on_message(filters.command('id') & (filters.private | filters.group))
...
@phoethar2.on_message((filters.private | filters.group) & filters.command('status'))
...
@phoethar2.on_message(filters.command('start') & filters.private)
...
@phoethar2.on_message(filters.command('help') & filters.private)
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/XGTh2RG9RHZkZjU1"),
                    InlineKeyboardButton("Support Group", url="https://t.me/XGTh2RG9RHZkZjU1")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
...
@phoethar2.on_message(filters.command('about') & filters.private)
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://www.pronhub.com")
                ],
                [
